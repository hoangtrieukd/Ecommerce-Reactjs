  ...
  render() {
    ...
    return (
      <div className={styles.outbox}>
        ...
        <div
          className={`${styles.content} ${this.state.isShow &&
            styles.show_content}`}
        >
          {/* order */}
          <div className={styles.order_box}>
            <div className={styles.head_title}>
              <img src="" alt="" />
              <div className={styles.head_title_text}>ORDER</div>
            </div>
                ...
                return (
                  <Selection
                    ...
                    selected={
                      !!(
                        selected_name["order"] &&
                        selected_name["order"].includes(n)
                      )
                    }
                    onChange={onChange}
                  />
          ...
          <div className={styles.filter_box}>
            <div className={styles.head_title}>
              <img src="" alt="" />
              <div className={styles.head_title_text}>FILTER</div>
            </div>
            <div className={styles.box}>
              {/* department */}
              <div className={styles.selection}>
                <Selection
                  title="DEPARTMENT"
                  selected={
                    selected_name["department"] &&
                    selected_name["department"].length > 0
                  }
                  onChange={() => {}}
                />
              ...
              <div className={styles.selection}>
                <Selection
                  title="PRICE"
                  selected={
                    selected_name["price"] && selected_name["price"].length > 0
                  }
                  onChange={() => {}}
                />
                <div className={styles.sub_selection}>
