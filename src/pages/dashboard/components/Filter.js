...
export default class Filter extends Component {
  ...
  handleChange = (e, category, name) => {
    ...
    if (name) {
      ...
      isChecked = !!!(
        this.state[category] && this.state[category].includes(name)
      );
    } else {
  ...
  clearAllFilter = () => {
    this.setState({ order: [], price: [], department: [] }, () =>
            ...
            <div className={styles.box}>
              ...
              <div className={styles.content}>
                ...
                <div className={styles.block}>
                  <div className={styles.sub_title}>ORDER</div>
                  {this.FILTER_CONFIG["order"].map(n => (
                    <Checkbox
                      ...
                      isChecked={
                        (this.state["order"] &&
                          this.state["order"].includes(n.toUpperCase())) ||
                        false
                      }
                    />
                  ))}
                    ...
                    <Checkbox
                      ...
                      isChecked={
                        (this.state["department"] &&
                          this.state["department"].includes(n.toUpperCase())) ||
                        false
                      }
                    />
                  ))}
                ...
                {/* price */}
                <div className={styles.block}>
                  <div className={styles.sub_title}>PRICE</div>
                  {this.FILTER_CONFIG["price"].map(n => (
                    <Checkbox
                      ...
                      isChecked={
                        (this.state["price"] &&
                          this.state["price"].includes(n.toUpperCase())) ||
                        false
                      }
                    />
                  ))}
